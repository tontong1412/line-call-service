...
from libs.TraceHeader import findIntersection, calculatePixels
from libs.CourtMapping import courtMap, showLines, showPoint, heightP, widthP, givePoint

widthP = int(967)
heightP = int(1585)

# Retrieve video from video file
video = VideoCapture('halfcourt30.mp4')
width = int(video.get(3))
height = int(video.get(4))

fourcc = VideoWriter_fourcc(*'mp4v')
clip = VideoWriter('court_detection/video.mp4',fourcc,25.0,(widthP,heightP))
processedFrame = None
